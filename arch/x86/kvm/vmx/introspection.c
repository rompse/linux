...
u64 intro_init_win_context(struct windows_context* ctx);
u64 intro_init_pe(void);

u64 intro_get_ntoskrnl_entrypoint(struct kvm_vcpu* vcpu);
u64 intro_get_ntoskrnl(struct kvm_vcpu* vcpu);
